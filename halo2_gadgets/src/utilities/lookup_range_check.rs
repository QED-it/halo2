...
mod tests {
    ...
    impl<F: PrimeFieldBits, Lookup: LookupRangeCheck<F, K>> Default for LookupRCCircuit<F, Lookup> {
        fn default() -> Self {
            Self {
    ...
    impl<F: PrimeFieldBits, Lookup: LookupRangeCheck<F, K>> Default for ShortRCCircuit<F, Lookup> {
        fn default() -> Self {
            Self {
