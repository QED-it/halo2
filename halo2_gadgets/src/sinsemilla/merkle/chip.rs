...
use crate::sinsemilla_opt::chip::SinsemillaConfigOptimized;
...
impl_trait_Chip_for!(MerkleChip<Hash, Commit, Fixed>, MerkleConfig<Hash, Commit, Fixed>);

#[macro_export]
macro_rules! impl_trait_MerkleChipProps_for_MerkleChip {
    ($merkle_config_name: ident, $merkle_chip_type:ty, $merkle_config_type:ty, $sinsemilla_config_type:ty) => {
        impl<Hash, Commit, F> $merkle_chip_type
        where
            Hash: HashDomains<pallas::Affine>,
            ...
            Commit: CommitDomains<pallas::Affine, F, Hash>,
        {
            ...
            pub fn configure(
                ...
                sinsemilla_config: $sinsemilla_config_type,
            ) -> $merkle_config_type {
            ...
            pub fn construct(config: $merkle_config_type) -> Self {
                Self { config }
            }
        }
    };
...
impl_trait_MerkleChipProps_for_MerkleChip!(
    MerkleConfig,
    MerkleChip<Hash, Commit, F>,
    MerkleConfig<Hash, Commit, F>,
    SinsemillaConfig<Hash, Commit, F>
);
#[macro_export]
macro_rules! impl_trait_MerkleInstructions_for_MerkleChip {
    ($chip_type:ty) => {
...
impl_trait_MerkleInstructions_for_MerkleChip!(MerkleChip<Hash, Commit, F>);

#[macro_export]
macro_rules! impl_trait_UtilitiesInstructions_for {
    ($chip_type:ty) => {
        impl<Hash, Commit, F> UtilitiesInstructions<pallas::Base> for $chip_type
        where
            Hash: HashDomains<pallas::Affine>,
            F: FixedPoints<pallas::Affine>,
            Commit: CommitDomains<pallas::Affine, F, Hash>,
...
impl_trait_UtilitiesInstructions_for!(MerkleChip<Hash, Commit, F>);
#[macro_export]
macro_rules! impl_trait_CondSwapInstructions_for {
    ($chip_type:ty) => {
        impl<Hash, Commit, F> CondSwapInstructions<pallas::Base> for $chip_type
        where
            Hash: HashDomains<pallas::Affine>,
            F: FixedPoints<pallas::Affine>,
            Commit: CommitDomains<pallas::Affine, F, Hash>,
...
impl_trait_CondSwapInstructions_for!(MerkleChip<Hash, Commit, F>);

#[macro_export]
macro_rules! impl_trait_SinsemillaInstructions_for_MerkleChip {
    ($merkle_chip_type:ty, $sinsemilla_chip_type:ty,$sinsemilla_chip_expr:expr) => {
        impl<Hash, Commit, F> SinsemillaInstructions<pallas::Affine, { sinsemilla::K }, { sinsemilla::C }>
            for $merkle_chip_type
        where
            Hash: HashDomains<pallas::Affine>,
            F: FixedPoints<pallas::Affine>,
            Commit: CommitDomains<pallas::Affine, F, Hash>,
        {
            type CellValue = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::CellValue;

            type Message = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::Message;
            type MessagePiece = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::MessagePiece;
            type RunningSum = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::RunningSum;

            type X = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::X;
            type NonIdentityPoint = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::NonIdentityPoint;
            type FixedPoints = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::FixedPoints;

            type HashDomains = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::HashDomains;
            type CommitDomains = <$sinsemilla_chip_type as SinsemillaInstructions<
                pallas::Affine,
                { sinsemilla::K },
                { sinsemilla::C },
            >>::CommitDomains;
            ...
            fn witness_message_piece(
                ...
                let chip = $sinsemilla_chip_expr(config);
...
impl_trait_SinsemillaInstructions_for_MerkleChip!(MerkleChip<Hash, Commit, F>, SinsemillaChip<Hash, Commit, F>,SinsemillaChip::<Hash, Commit, F>::construct);
