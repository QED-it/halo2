    ...
    fn dump_vesta_lean_fixture_with_mode<R: Read>(
        ...
        match mode {
            ...
            FixtureMode::MatchOnly => {
                ...
                out.push_str("-- Match-only capture: the deployed verifier ran to completion on a random proof\n");
                out.push_str(
